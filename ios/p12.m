...
- (IBAction)enviar:(id)sender {
    ...
    if([registrado isEqualToString:@"YES"]){
        UIAlertView* mes=[[UIAlertView alloc] initWithTitle:@"Mi decisión" message:@"Después de haber entendido que el juicio investigador comenzó el 22 de octubre de 1844, deseo prepararme buscando a Jesús." delegate:self cancelButtonTitle:@"Acepto" otherButtonTitles: nil];
    [mes show];
    ...
    if(p3a.isOn){
        ...
        [post appendString:@"&numeroLeccion=12&idRegistro="];
