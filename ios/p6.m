...
- (IBAction)enviar:(id)sender {
    ...
    UIAlertView* mes=[[UIAlertView alloc] initWithTitle:@"Mi decisión" message:@"Entendiendo que solo puedo ser justo cuando voy a Jesús, decido vivir con él y para él el resto de mi vida." delegate:self cancelButtonTitle:@"Acepto" otherButtonTitles: nil];
    [mes show];
    ...
    if(p4a.isOn){
        ...
        [post appendString:@"&numeroLeccion=6&idRegistro="];
