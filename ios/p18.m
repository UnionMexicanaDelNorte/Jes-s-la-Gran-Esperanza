...
- (IBAction)enviar:(id)sender {
    ...
    if([registrado isEqualToString:@"YES"]){
        UIAlertView* mes=[[UIAlertView alloc] initWithTitle:@"Mi decisión" message:@"Por la gracia de Dios, deseo traer personas a Cristo, y escribo aquí el nombre de cinco (5) personas por las cuales oraré y trabajaré." delegate:self cancelButtonTitle:@"Acepto" otherButtonTitles: nil];
        [mes show];
        ...
        [post appendString:@"&numeroLeccion=18&idRegistro="];
