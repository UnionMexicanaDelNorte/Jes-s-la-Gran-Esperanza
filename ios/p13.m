...
- (IBAction)enviar:(id)sender {
    ...
    if([registrado isEqualToString:@"YES"]){
     UIAlertView* mes=[[UIAlertView alloc] initWithTitle:@"Mi decisión" message:@"Después de haber entendido que mi cuerpo es templo del Espíritu Santo y que no es mío, decido cuidar mi cuerpo, con la ayuda de Dios." delegate:self cancelButtonTitle:@"Acepto" otherButtonTitles: nil];
    [mes show];
    ...
    [_respuesta appendString:@"\n\n"];
    [_respuesta appendString:p3d.text];
        ...
        [post appendString:@"&numeroLeccion=13&idRegistro="];
