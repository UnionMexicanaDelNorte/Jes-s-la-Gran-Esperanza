...
- (IBAction)enviar:(id)sender {
    ...
    UIAlertView* mes=[[UIAlertView alloc] initWithTitle:@"Mi decisión" message:@"Después de entender que toda la divinidad está interesada en mi salvación, acepto a Dios en sus tres personas, Padre, Hijo y Espíritu Santo." delegate:self cancelButtonTitle:@"Acepto" otherButtonTitles: nil];
    [mes show];
    ...
    if(p3a.isOn){
        ...
        [post appendString:@"&numeroLeccion=11&idRegistro="];
