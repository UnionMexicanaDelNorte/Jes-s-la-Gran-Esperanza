...
- (IBAction)enviar:(id)sender {
    ...
    UIAlertView* mes=[[UIAlertView alloc] initWithTitle:@"Mi decisión" message:@"Habiendo entendido que Jesús vuelve en gloria para ponerle un punto final a la historia del pecado y para llevarme con él, deseo prepararme para vivir con Jesús por la eternidad" delegate:self cancelButtonTitle:@"Acepto" otherButtonTitles: nil];
    [mes show];
    ...
    if(p3a.isOn){
        ...
        [post appendString:@"&numeroLeccion=8&idRegistro="];
