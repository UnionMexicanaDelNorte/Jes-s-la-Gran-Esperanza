...
- (IBAction)enviar:(id)sender {
    ...
    UIAlertView* mes=[[UIAlertView alloc] initWithTitle:@"Mi decisión" message:@"Después de haber entendido que guardar los mandamientos de Dios es una expresión de mi amor por Cristo, acepto los mandamientos de Dios en mi vida." delegate:self cancelButtonTitle:@"Acepto" otherButtonTitles: nil];
    [mes show];
    ...
    if(p3a.isOn){
        ...
        [post appendString:@"&numeroLeccion=10&idRegistro="];
