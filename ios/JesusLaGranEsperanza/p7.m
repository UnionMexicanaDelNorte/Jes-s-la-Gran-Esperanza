...
- (IBAction)enviar:(id)sender {
    ...
    UIAlertView* mes=[[UIAlertView alloc] initWithTitle:@"Mi decisión" message:@"Habiendo entendido que Jesús tiene un día especial para darme reposo y prepararme para una nueva semana de desafíos, decido guardar el sábado." delegate:self cancelButtonTitle:@"Acepto" otherButtonTitles: nil];
    [mes show];
    ...
    [_respuesta appendString:@"\n\n"];
    [_respuesta appendString:p1c.text];
    [_respuesta appendString:@"\n\n"];
    ...
    if(p3a.isOn){
        ...
        [post appendString:@"&numeroLeccion=7&idRegistro="];
